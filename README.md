...
Algoritmo minimax para jugar Knight Chess. El algoritmo funciona de esta manera:
...
Para la evaluación de posición se utilizó el siguiente mapa (sacado de https://www.chessprogramming.org/Simplified_Evaluation_Function):
