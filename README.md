...
2. Por cada jugada posible, se utiliza la función best_available_movement, que encuentra la jugada mejor evaluada, ya sea para el jugador o para el rival, un total de n-1 veces, donde n es la profundidad del algoritmo (por defecto, n es 4).
